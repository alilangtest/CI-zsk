            ...
            layui.use(['layer'], function(){
                ...
                $('#add').click(function(){
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true,
                        content: '/admin/knowledge/Intellectual/intellectual_add/'
                    });
                });
                //删除操作
                $(".del").click(function(){
                    ...
                    $.post("/admin/knowledge/intellectual/intellectual_del/", { id: id },
                        function(ee){
...
//                $.post("/admin/knowledge/different/different_add",$("#addt").serialize(),
                    $.post("/admin/knowledge/intellectual/intellectual_del/", { id:vals },
                        function(data){
                            if(data.status == 1){
                ...
                $('.update').click(function(){
                    ...
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true,
                        content: '/admin/knowledge/intellectual/intellectual_update/'+id
                    });
                });
                ...
                $('.share').click(function(){
                    ...
                    layer.open({
                        ...
                        area: ['500px', '500px'],
                        type: 2,
                        content: '/admin/knowledge/intellectual/intellectual_share/?ids='+id,
                    });
                ...
                $('.look').click(function(){
                    ...
                    layer.open({
                            ...
                            fixed: false, //不固定
                            maxmin: true,
                            content: '/admin/knowledge/Intellectual/show_single/'+id
                        });
...
//                    alert(vals);
                    ...
                    layer.open({
                        ...
                        area: ['500px', '500px'],
                        type: 2,
                        content: '/admin/knowledge/intellectual/intellectual_share/?ids='+vals,
                    });
...
<blockquote class="layui-elem-quote">
    <form style="float:left;" method="get" action="/admin/knowledge/Intellectual/intellectual_list/" >
        <div class="layui-input-inline">
            <input type="text" name="kw" value=""  lay-verify="required" placeholder="请输入标题/分类" autocomplete="off" class="layui-input hsl">
        </div>&nbsp;
