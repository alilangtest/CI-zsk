...
//            var index = layedit.build('demo'); //建立编辑器
            ...
            form.on('submit(sub)', function(data){
                ...
                var dt = data.field;
                $.post("/admin/knowledge/Dpt_intellectual/dpt_intellectual_add",{ title:dt.title,column:dt.column,keyword:dt.keyword,describe:dt.describe,sort:dt.sort,content:content },
                    function(ee){
                        if(ee.status == 1){
