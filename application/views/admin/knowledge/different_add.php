...
<div class="ty">
    <form class="layui-form" id="addt">
            ...
            <div class="layui-input-block">
                <input name="tname" lay-verify="title" autocomplete="off" placeholder="请输入分类名称" class="layui-input flmc" type="text">
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label">排  序 ：</label>
                <div class="layui-input-block">
                    <input name="sort" lay-verify="title" autocomplete="off" placeholder="请输入分类排序" class="layui-input flmc" type="text">
                </div>
            </div>
